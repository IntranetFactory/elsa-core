...
namespace Elsa.Persistence
{
    ...
    {   
        ...
        Task<IEnumerable<(WorkflowInstance WorkflowInstance, WorkflowInstanceTask blockingWorkflowInstanceTask)>> ListByBlockingActivityTagAsync(int? tenantId, string activityType, string tag, string? correlationId = default, CancellationToken cancellationToken = default);
        Task<IEnumerable<(WorkflowInstance WorkflowInstance, WorkflowInstanceTask blockingWorkflowInstanceTask)>> ListByBlockingActivityTagAsync(int? tenantId, string tag, string? correlationId = default, CancellationToken cancellationToken = default);
        Task<IEnumerable<(WorkflowInstance WorkflowInstance, WorkflowInstanceTask blockingWorkflowInstanceTask)>> ListByBlockingActivityAsync(int? tenantId, string activityType, string? correlationId = default, CancellationToken cancellationToken = default);
