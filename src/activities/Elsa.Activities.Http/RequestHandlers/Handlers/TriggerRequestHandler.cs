...
//            var queryTenantId = httpContext.Request.Query["tenantId"];
//            int parsedTenantId;
//            bool parseResult = Int32.TryParse(queryTenantId, out parsedTenantId);
//            int? tenantId = parseResult == true ? parsedTenantId : default;
...
//        private IEnumerable<(WorkflowInstance WorkflowInstance, ActivityDefinition BlockingActivity)> Filter(
//            IEnumerable<(WorkflowInstance WorkflowInstance, ActivityDefinition BlockingActivity)> items,
//            PathString path,
//            string method) =>
...
//        private async Task InvokeWorkflowsToResumeAsync(IEnumerable<(WorkflowInstance, ActivityDefinition)> items)
//        {
